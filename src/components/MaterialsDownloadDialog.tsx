...
import { Download, FileText, FileType, Loader2, Inbox, AlertCircle, RefreshCw, LogIn, Lock } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl surface-elevated border max-h-[80vh] overflow-hidden flex flex-col">
        ...
        {/* ── Not signed in: show lock screen ── */}
        {!user ? (
          <div className="flex flex-col items-center justify-center py-10 gap-4 text-center">
            ...
            <div>
              <p className="font-semibold text-foreground">Sign in to access materials</p>
              <p className="text-sm text-muted-foreground mt-1">
                Create a free account to download PDFs, slides, and notes.
              </p>
            </div>
            <Button
